...
# ============================================
WALK_AMPLITUDES = {
    LEFT_HIP_ROLL: 0.0, LEFT_HIP_YAW: 0.0089, LEFT_HIP_PITCH: 0.066,
    LEFT_KNEE_PITCH: 0.129, LEFT_ANKLE_PITCH: 0.063, LEFT_ANKLE_ROLL: 0.069,
    
    RIGHT_HIP_ROLL: 0.0, RIGHT_HIP_YAW: 0.0089, RIGHT_HIP_PITCH: 0.066,
    RIGHT_KNEE_PITCH: 0.129, RIGHT_ANKLE_PITCH: 0.063, RIGHT_ANKLE_ROLL: 0.069,
}


for key in WALK_AMPLITUDES:
    WALK_AMPLITUDES[key] *= 10  # 진폭을 절반으로 줄임
...
for device_id in left_leg_ids:
    ...
    bus_left.write_torque_limit(device_id, 1.0)
...
for device_id in right_leg_ids:
    ...
    bus_right.write_torque_limit(device_id, 1.0)
